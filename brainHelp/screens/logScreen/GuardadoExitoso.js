  ...
  return (
    ...
    <View style={[globalStyles.contendor, globalStyles.contenedorBordes]}>
      <View style={styles.contenedor}>
        <Text style={styles.titulo}>¡Registro añadido!</Text>
      </View>
      <View style={styles.contenedorImagen}>
      <Image
        style={styles.imagen}
        source={require('../../assets/img/registroCompleto.png')}
      />
      </View>
      <Text style={styles.recordatorio}>
       <Text style={styles.recordatorio2}> Recuerda: {'\n'}</Text>Es muy importante llevar un control constante de tus crisis.
      </Text>
      <Button
        mode="contained"
        onPress={() => navigation.navigate('PantallaPrincipal', {datos})}
        style={styles.boton}>
        Finalizar
      </Button>
    </View>
